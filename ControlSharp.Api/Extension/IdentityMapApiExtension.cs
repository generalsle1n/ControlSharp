...
public static class IdentityMapApiExtension
{
    private static readonly EmailAddressAttribute _emailAddressAttribute = new();
    public static IEndpointConventionBuilder MapIdentityApiRaw<TUser>(this IEndpointRouteBuilder endpoints, MapApiFeatures Features)
        where TUser : class, new()
    {
        ...
        if (Features.Register)
        {
                ...
                ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
            {
                ...
                {
                    throw new NotSupportedException($"{nameof(MapIdentityApiRaw)} requires a user store with email support.");
                }
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapIdentityApiRaw)}-{finalPattern}";
            endpointBuilder.Metadata.Add(new EndpointNameMetadata(confirmEmailEndpointName));
        });
        }

        if (Features.ResendConfirmMail)
        {
