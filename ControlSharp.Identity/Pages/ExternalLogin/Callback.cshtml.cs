...
namespace ControlSharp.Identity.Pages.ExternalLogin;
...
public class Callback : PageModel
{
    ...
    public Callback(UserManager<UserIdentity> userManager, SignInManager<UserIdentity> signInManager, IIdentityServerInteractionService interaction, IEventService events, ILogger<Callback> logger)
    {
